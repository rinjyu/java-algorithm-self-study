...
public class BinarySearchTrace {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(String.format("반복 실행 전 : x = %d, pointer = %d, left = %d, middle = ?, right = %d", x, pointer, left, right));
        ...
        while (pointer == -1 && left <= right) {
            ...
            System.out.println(String.format("반복 실행 중 : pointer = %d, left = %d, middle = %d, right = %d", x, pointer, left, middle, right));
        }
